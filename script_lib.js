var array = ["url('red2.jpg')","url('silver2.jpg')","url('black2.jpg')"];
/*var array = [];
for (var i = 0; i < myarray.length; i++) {
	array[i] = "url('" + myarray[i] +"')";
}*/
...
/*			objperspective.style.margin = "200px auto";*/
	...
	for (var i = 0; i < ivalue; i++) {
		...
		for (var j = 0; j < jvalue; j++) {
			...
			objrotateside[i][j].style.zIndex = 10;
			...
			objrotatesidetop[i][j].style.zIndex = -1;
			...
			objrotatesideleft[i][j].style.zIndex = -1;
			...
			objrotatesideright[i][j].style.zIndex = -1;	
			...
			objrotatesidebottom[i][j].style.zIndex = -1;
		}
	}
}
...
function dsconnect_library_fun() {
/*	window.location.reload();*/
	document.body.removeChild(objperspective);
	var obj = document.createElement("img");
	document.body.appendChild(obj);
	obj.src = myarray[(n % 3)];
	obj.addEventListener("click", myfun);

/*	document.write('<img src="red2.jpg" onclick="myfun()">');*/
}
...
window.onmousemove = function(event) {
	...
	objrotate[1][1].style.transform = "rotateY(" + x + "deg)" + "rotateX(" + y + "deg)";
	objrotate[1][1].style.transform = "rotateY(" + x + "deg)" + "rotateX(" + y + "deg)";
}*/
...
window.onkeydown = 	function(event) {
	...
	objrotate[2][2].style.transform = "rotateY(" + x + "deg)" + "rotateX(" + y + "deg)";
	objrotate[2][2].style.transform = "rotateY(" + x + "deg)" + "rotateX(" + y + "deg)";
}
